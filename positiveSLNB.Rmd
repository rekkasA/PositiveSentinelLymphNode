...
```{r leave1outCalRec, echo = TRUE, fig.cap="\\label{fig:leave1outCalRec}Leave one center out cross validation for the prediction of 5-year recurrence", fig.align = "center", fig.width = 8, fig.height = 8}
...
```{r leave1outCalDistant, echo = TRUE,fig.cap="\\label{fig:leave1outCal}Leave one center out cross validation of the calibrated model for 5-year distant metastasis", fig.align = "center", fig.width = 8, fig.height = 8}
SRecurrence  <- Surv(dat$timeToRecurrence60,
                     dat$status_RFS_FDA60)
form <- SRecurrence ~ ulceration + log(age) + log(SN_tumor_burden) + log(breslow)
centers <- unique(dat$center)
...
```{r leave1outCalDeath, echo = TRUE,fig.cap="\\label{fig:leave1outCalDeath}Leave one center out cross validation of the calibrated model for 5-year overall mortality", fig.align = "center", fig.width = 8, fig.height = 8}
SRecurrence  <- Surv(dat$timeToRecurrence60,
                     dat$status_RFS_FDA60)
form <- SRecurrence ~ ulceration + log(age) + log(SN_tumor_burden) + log(breslow)
centers <- unique(dat$center)
...
```{r nomogram, echo = TRUE, fig.cap="\\label{fig:nomogram}Nomogram for 5-year recurrence", fig.align = "center", fig.width = 7.5, fig.height = 7.5}
...
```{r combinedPlot, echo = TRUE, fig.cap="\\label{fig:combinedPlot}Absolute risks along with risk distribution",fig.align = "center", fig.width = 8.5, fig.height = 7}
...
```{r calibrationPlotRec, echo = TRUE, fig.cap="\\label{fig:calibrationPlotRec}Calibration plot of 5-year recurrence model", fig.align = "center"}
...
```{r calibrationPlotDistant, echo = TRUE, fig.cap="\\label{fig:calibrationPlotDistant}Calibration plot of 5-year distant metastasis model", fig.align = "center"}
...
```{r calibrationPlotDeath, echo = TRUE, fig.cap="\\label{fig:calibrationPlotDeath}Calibration plot of 5-year overall mortality model", fig.align = "center"}
...
```{r cIndexOverallModels, echo = TRUE}
...
```{r leave1outCalMerged, echo = TRUE, fig.cap="\\label{fig:leave1outCalMerged}Leave-one-center-out cross validation for prediction of recurrence in the merged dataset",fig.align = "center", fig.width = 8, fig.height = 8}
discrimination <- list()
centers <- unique(dat$center)
par(mfrow=c(3, 3))
for(i in 1:length(centers)){
...
```{r nomogramMerged, echo = TRUE, fig.cap="\\label{fig:nomogramMerged}Nomogram for 5-year recurrence for the merged dataset", fig.align = "center", fig.width = 7, fig.height = 7}
breslow.class <- c(0.1, .15, .25, .4, .6, 1, 1.5, 2.5, 4, 6, 8, 10)
...
```{r leave1outCalDistantMerged, echo = TRUE,fig.cap="\\label{fig:leave1outCalDistantMerged}Leave-one-center-out cross validation for prediction of distant metastasis in the merged dataset", fig.align = "center", fig.width = 8, fig.height = 8}
...
```{r leave1outCalDeathMerged, echo = TRUE,fig.cap="\\label{fig:leave1outCalDeathMerged}Leave-one-center-out cross validation for prediction of overall mortality in the merged dataset", fig.align = "center", fig.width = 8, fig.height = 8}
SRecurrence  <- Surv(dat$timeToRecurrence60,
                     dat$status_RFS_FDA60)
form <- SRecurrence ~ ulceration + log(age) + log(SN_tumor_burden) + log(breslow)
discrimination <- list()
...
```{r combinedPlotMerged, echo = TRUE, fig.cap="\\label{fig:combinedPlotMerged}Absolute risks along with risk distribution using the merged dataset",fig.align = "center", fig.width = 8.5, fig.height = 7}
ggplot(data = pointsToProbs, aes(x = points)) +
...
kable(resSimpleRec %>%
        mutate(surv = round(surv, 2),
               lower = round(lower, 2),
               upper = round(upper, 2)), 
      caption = "5-year recurrence-free survival with EJC subgroups") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
kable(resSimpleDistant %>%
        mutate(surv = round(surv, 2),
               lower = round(lower, 2),
               upper = round(upper, 2)),
      caption = "5-year distant metastasis free survival with EJC subgroups") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
kable(resSimpleDeath %>%
        mutate(surv = round(surv, 2),
               lower = round(lower, 2),
               upper = round(upper, 2)),
      caption = "5-year overall survival with EJC subgroups") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
